...
public class UploadTestResultToAlmModel {
	...
	public final static EnumDescription testingFrameworkJunit = new EnumDescription("JUnit", "JUnit");
	public final static EnumDescription testingFrameworkTestNG = new EnumDescription("TestNG", "TestNG");
	public final static EnumDescription testingFrameworkNUnit = new EnumDescription("NUnit", "NUnit");
	public final static List<EnumDescription> testingFrameworks = Arrays.asList(testingFrameworkJunit,
			testingFrameworkTestNG, testingFrameworkNUnit);
	...
	public UploadTestResultToAlmModel(String almServerName, String almUserName, String almPassword, String almDomain,
			String clientType, String almProject, String testingFramework, String testingTool, String almTestFolder,
			String almTestSetFolder, String almTimeout, String testingResultFile, String jenkinsServerUrl,
			Map<String, String> testSetFields, Map<String, String> testCaseFields) {
	...
	public String toString() {
		return almServerName + "," + almUserName + "," + almPassword + "," + almDomain + "," + clientType + ","
				+ almProject + "," + almTimeout + "," + almTestFolder + "," + almTestSetFolder + "," + testingFramework
				+ "," + testingTool + "," + testingResultFile + "," + jenkinsServerUrl + "," + testSetFields + ","
				+ testCaseFields;
	}
}
=======
...
>>>>>>> branch 'latest' of https://github.com/benauca/hpe-application-automation-tools-plugin.git
