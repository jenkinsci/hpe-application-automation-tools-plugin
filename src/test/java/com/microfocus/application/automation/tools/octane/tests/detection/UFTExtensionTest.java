...
public class UFTExtensionTest {
	...
	public void testMockMoreBuilders() throws Exception {
		...
		project.getBuildersList().add(new RunFromAlmBuilder("notExistingServer", "JOB", "sa", "", "domain", "project", "notExistingTests", "", "", "", "", "","", false, false, false, filterTestsModel, parametersModel, almServerSettingsModel, "id"));
